...
args.seed1
args.seed2
folder_path = '/dcs/pg23/u1604520/mem/results/times/results_berkson_mmd/'
...
def train_npl(params, reg_func, seed1, seed2):
    ...
    return sample, mmd_est, data, x, total
...
if __name__=='__main__':
    ...
    for r in tqdm(range(R)):
        ...
        for p,params in enumerate(list(product(n,loc_x,scale_x,scale_nu,scale_eps,B,m,c,T,p_))):
            ...
            sample, mmd_est, data, x, total = train_npl(np.array(params), reg_func, args.seed1, args.seed2)
