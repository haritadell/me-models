...
class npl():
    ...
    def __init__(self, data, B, m, c, T, seed, lx, ly, prior):
        ...
        self.prior = prior  
        # Check the unique values of w to get number of groups / values and sizes
    ...
    def minimise_MMD(self, data, weights, x_tilde, key, Nstep=700, eta=0.01):  #0.1
      ...
      # Initialization of theta for optimisation: here you can start from a fixed point or uniformly sample from a range of values or from
